          ...
          <div className="mx-auto max-w-4xl px-4">
            <div className="relative mx-auto mt-20 rounded-xl border-2 border-dashed border-amber-500 bg-black/75 p-6 text-lg text-white shadow-2xl sm:text-2xl">
              ...
              <div className="mb-4">
                ...
                <p>
                  <span className="text-blue-400">$BLUB</span> is the funniest and most degenerate fish in the <span className="text-sky-300">Solana Ocean</span>, staying true to its origins and bringing the chaotic energy of the 'Boy's Club'—the creators of <span className="text-green-600">$PEPE</span>—to the <span className="text-sky-300">Solana Network</span>. With its dirty and clumsy manner, <span className="text-blue-400">$BLUB</span> causes real chaos in the coral. <br />
                  <div className="mt-6"></div>
                  It brings a unique theme and perfect synergy with the <span className="text-sky-300">Solana Network</span>, making it an irresistible crypto for those who love memes and aspire to conquer oceans and achieve dreams.
                </p>
              </div>
              <div>
                <h3 className="border-t border-slate-500 py-4 text-2xl font-semibold">Contract Address</h3>
                <div className="flex max-w-full items-center gap-x-2 text-xl">
                  <p className="max-w-[250px] md:text-base text-sm break-words sm:max-w-[400px] md:max-w-[600px]">To Be Announced</p>
                  <div className="w-8">
